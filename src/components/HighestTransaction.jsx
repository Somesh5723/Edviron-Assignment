  ...
  const data = [
    {
      user: {
        name: "Jennie",
        avtar: "https://randomuser.me/api/portraits/women/55.jpg",
      },
      sales: "40k+ sales",
    ...
    },
    {
      user: {
        name: "John",
        avtar: "https://randomuser.me/api/portraits/men/37.jpg",
      },
      sales: "40k+ sales",
      revenue: "$1.4m revenue",
    },
    {
      user: {
        name: "Hardik",
        avtar: "https://randomuser.me/api/portraits/men/50.jpg",
      },
      sales: "40k+ sales",
      revenue: "$1.4m revenue",
    },
