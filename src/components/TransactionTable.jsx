  ...
  const data = [
    {
      user: {
        name: "Sushma",
        avtar: "https://randomuser.me/api/portraits/women/23.jpg",
      },
      status: "verified",
      ratings: 60,
      quantity: 400,
    ...
    },
    {
      user: {
        name: "Shivam",
        avtar: "https://randomuser.me/api/portraits/men/7.jpg",
      },
      status: "pending",
      ratings: 30,
      quantity: 200,
    ...
    },
    {
      user: {
        name: "Rishi",
        avtar: "https://randomuser.me/api/portraits/men/10.jpg",
      },
    ...
    },
    {
      user: {
        name: "Ritu",
        avtar: "https://randomuser.me/api/portraits/women/12.jpg",
      },
      status: "unverified",
      ratings: 0,
      quantity: 0,
    ...
    },
    {
      user: {
        name: "Amrendra",
        avtar: "https://randomuser.me/api/portraits/men/17.jpg",
      },
    ...
    },
    {
      user: {
        name: "Ananya",
        avtar: "https://randomuser.me/api/portraits/women/14.jpg",
      },
